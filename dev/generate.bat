...
d:\xampp\php\php wsdl2phpgenerator-2.5.5.phar -i https://promotionaloffice.cloudapp.net/PromotionalOffice/Services/UniversalImporter/CustomerImportService.svc?wsdl -o CustomerImportService
