...
class TenderInformationPositionItem
{
    ...
    /**
     * @var TenderInformationBettermentItem[] $TenderInformationBetterments
     * @access public
     */
    public $TenderInformationBetterments = null;

    /**
     * @var InlineCostInformationIem[] $TenderInlineCostInformations
     * @access public
     */
