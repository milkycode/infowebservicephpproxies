...
class CustomerImportService extends \SoapClient
{
     ...
     * @access public
     */
    public function __construct(array $options = array(), $wsdl = 'http://ec2-52-28-194-243.eu-central-1.compute.amazonaws.com/Promidata/PromotionalOffice/Services/UniversalImporter/CustomerImportService.svc?wsdl')
    {
